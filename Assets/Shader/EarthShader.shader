Shader "Planet/PlanetShader"
{
	Properties
	{
		...
		_DetailIntensity("Detail Intensity", Range(0, 3)) = 3.0
		_DetailIntensityMin("Detail Intensity Minimum", Range(0, 1)) = 1.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 detailColor = tex2D(_DetailTex, i.uv) * _DayTintColor;
